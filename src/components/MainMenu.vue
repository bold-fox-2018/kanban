                        ...
                        >
                            <form @submit.prevent="handleSubmit">
                                <b-row class="mb-3">
                                    ...
                                    <b-col><b-form-input type="text" placeholder="Enter your task" v-model="title" /></b-col>
                                </b-row>

                                <b-row class="mb-3">
                                    <b-col cols="2">Description</b-col>
                                    <b-col><b-form-textarea id="textarea-small" size="sm" placeholder="Small textarea" v-model="description" /></b-col>
                                </b-row>

                                <b-row class="mb-3">
                                    <b-col cols="2">Point</b-col>
                                    <b-col><b-form-input type="number" placeholder="Enter your task" v-model="point" /></b-col>
                                </b-row>

                                <b-row class="mb-3">
                                    <b-col cols="2">Assigned To</b-col>
                                    <b-col><b-form-input type="text" placeholder="Enter your task" v-model="assignTo" /></b-col>
                                </b-row>
                            </form>
                        </b-modal>
                    </div>
